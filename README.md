...
## Extra: use yt-dlp
`yt-dlp` is a fork of `youtube-dl` with new features and patches (link: `https://github.com/yt-dlp/yt-dlp`). To use the source code with yt-dlp you have to edit the source code of the module `pafy`:
 - In file `pafy.py`:
